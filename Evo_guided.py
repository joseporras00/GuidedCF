...
import Evo_guided_utils as EvoUtils
from Evo_guided_utils import (
    create_logbook,
    create_mstats,
    eval,
    evaluate_pop,
...
class EvolutionaryOptimization:
    def __init__(
        ...
        self.toolbox.register("mate", recombine, ig_values=exp_ig, percentile=percentile)
        self.toolbox.register(
            "mutate", getattr(EvoUtils, transformer), ig_values=exp_ig, reference_set=reference_set, top_fraction=top_fraction
        )
